...
Date: 2024-10-14
Description: This script fine tunes the Bert Model using SQuAD dataset with prefix-tuning approach.
Version: 1.0
"""
import transformers
...
def main():
    ...
    with mlflow.start_run() as run:
        ...
        args = TrainingArguments(
            f"{model_name}-prefix-finetuned-squad",
        ...
        # Log the model
        mlflow.pytorch.log_model(model, "prefix-fine-tuned-model")
