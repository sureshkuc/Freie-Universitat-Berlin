...
Date: 2024-10-14
Description: This script fine tunes the Bert Model using SQuAD dataset with LoHA approach.
Version: 1.0
"""
import transformers
...
import time
import psutil
from peft import get_peft_model, LoHaConfig, TaskType
...
def main():
    ...
    with mlflow.start_run() as run:
        ...
        loha_config = LoHaConfig(
            ...
            #         # You can repeat for layers 1 through 5
            ...
            target_modules=["query", "value"] #it is for BERT model
        )
