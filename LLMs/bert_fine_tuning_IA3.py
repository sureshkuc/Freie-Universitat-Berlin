...
Date: 2024-10-14
Description: This script fine tunes the Bert Model using SQuAD dataset with IA3 approach.
Version: 1.0
"""
import transformers
...
def main():
    ...
    with mlflow.start_run() as run:
        ...
        args = TrainingArguments(
            f"{model_name}-IA3-finetuned-squad",
        ...
        peft_config = IA3Config(task_type=TaskType.QUESTION_ANS)
        ...
        # Log the model
        mlflow.pytorch.log_model(model, "IA3-model")
